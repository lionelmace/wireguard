...
1. Create a VPC
    ```
    ibmcloud is vpc-create vpc-wireguard
    ```

1. Create two subnets
    ```
    ibmcloud is subnet-create sub1-wireguard $vpc eu-de-1 --ipv4_cidr_block 10.243.0.0/24
    ibmcloud is subnet-create sub1-wireguard $vpc eu-de-2 --ipv4_cidr_block 10.243.64.0/24	
    ```

1. Add 4 **Inbound** Rules in the Security Group
...
1. Add 1 **Outbound** Rule in the Security
